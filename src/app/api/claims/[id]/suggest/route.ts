  ...
  try {
    const response = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        model: SUGGEST_MODEL,
        instructions:
          "당신은 Yogibo 고객센터 응대 표준화 담당입니다. 아래 'FAQ 게시판 내용'을 최우선 근거로 삼고, CS가 실제 응대한 내용을 참고하여, 게시판 정책과 일관된 표준 답변을 한국어로 작성하세요. 게시판 FAQ와 충돌하면 FAQ를 따르고, 근거에 없는 내용은 추측하지 마세요. 개인정보(이름·주문번호·연락처)는 답변에 넣지 마세요. 핵심만 3문장 이내로 친절하게 쓰세요. 카테고리는 주어진 목록 중 가장 적합한 하나를 고르세요. 반드시 JSON만 출력하세요.",
        input: `고객 문의:
${claim.situation}
